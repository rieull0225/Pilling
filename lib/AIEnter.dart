  ...
  Widget build(BuildContext context) {
    ...
    child : Padding(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.fromLTRB(1.5,0,309.5,0),
          ...
          Text("아래 설명과 유의사항을 읽고 진료실에 입장해주세요.",
              style: TextStyle(color : Colors.white, fontSize: 12, fontFamily: 'Apple',
                fontWeight: FontWeight.w100, decoration: TextDecoration.none, ),textAlign: TextAlign.center),
          SizedBox(height : 40),
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('의사와의 직접적인 진료 없이 인공지능과'
                      ...
                      ' 도와주는 비대면 진료 서비스입니다.', style: TextStyle(color : Color(0xff141922), fontSize: 12, fontFamily: 'Apple',
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('1)', style: TextStyle(color : Color(0xff141922), fontSize: 12, fontFamily: 'Apple',
                        fontWeight: FontWeight.w500, decoration: TextDecoration.none, ),textAlign: TextAlign.start),
                      SizedBox(width : 7.6),
                      Text('약물의 용량 조절 또는 약물 종류 변경은 전화 또는 화상\n진료를 통해서만 가능합니다.', style: TextStyle(color : Color(0xff141922), fontSize: 12, fontFamily: 'Apple',
                        fontWeight: FontWeight.w500, decoration: TextDecoration.none, ),textAlign: TextAlign.start),
                    ],
                  ),
                  SizedBox(height : 7),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('2)', style: TextStyle(color : Color(0xff141922), fontSize: 12, fontFamily: 'Apple',
                        fontWeight: FontWeight.w500, decoration: TextDecoration.none, ),textAlign: TextAlign.start),
                      SizedBox(width : 7.6),
                      Text('환자와의 공유 데이터 분석 중 이상이 발견되어 의사와의\n진료가 필요하다고 판단이 될시 약물 처방이 불가하며\n'
                          '전화 및 화상 진료 예약 페이지로 이동합니다.', style: TextStyle(color : Color(0xff141922), fontSize: 12, fontFamily: 'Apple',
                        fontWeight: FontWeight.w500, decoration: TextDecoration.none, ),textAlign: TextAlign.start),
                    ],
                  ),
