...
class drug2OK extends StatelessWidget {
  const drug2OK({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                    ...
                    children : [
                      Text("아빌리파이 2mg 1정", style: TextStyle(color : Color(0xff4271ff), fontSize: 20, fontFamily: 'Gmarket', fontWeight: FontWeight.w500),),
