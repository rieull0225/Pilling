...
List<Column> _onBoard = [
    ...
    children: <Widget>[
      GestureDetector(onTap:(){
        Get.to(()=>additional());
          ...
          child: SizedBox(width : 268 , height : 285 , child : Image.asset("assets/image/온보딩1.png"))),
      SizedBox(height : 52 ),
  ...
  Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        SizedBox(width : 285 , height : 268, child : Image.asset("assets/image/온보딩2.png")),
        SizedBox(height : 52 ),
  ...
  Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        SizedBox(width : 220, height : 232 , child : Image.asset("assets/image/온보딩3.png")),
        SizedBox(height : 49 ),
  ...
  Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        SizedBox(width : 220 , height : 232, child : Image.asset("assets/image/온보딩4.png")),
        SizedBox(height : 49 ),
