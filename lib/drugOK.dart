          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                SizedBox(width : 144),
                SizedBox(width : 90, child : Text("오전 08:30am", style : TextStyle(color : Color(0xff6b6b6b), fontSize: 14, ))),
              ],
            ),
            Padding(
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                SizedBox(width : 144),
                SizedBox(width : 90, child : Text("오전 08:32am", style : TextStyle(color : Color(0xff6b6b6b), fontSize: 14, ))),
              ],
            ),
            Padding(
              padding: const EdgeInsets.fromLTRB(30,14,30,14),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                SizedBox(width : 144),
                SizedBox(width : 90, child : Text("3일 째", style : TextStyle(color : Color(0xff6b6b6b), fontSize: 14,), textAlign: TextAlign.right,)),
              ],
            ),
