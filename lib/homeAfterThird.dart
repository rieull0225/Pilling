              ...
              children: [
                ...
                Row(
                  children: [
                    Text("김진규 원장", style : TextStyle(color : Color(0xff141922), fontSize: 18, fontWeight: FontWeight.w500)),
                    SizedBox(width : 3),
                    Text('마음샘정신건강의학과', style : TextStyle(color : Color(0xff929292), fontSize: 14, fontWeight: FontWeight.w300))
                  ],
                ),
                SizedBox(height : 7),
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("김진규 원장", style : TextStyle(color : Color(0xff141922), fontSize: 18, fontWeight: FontWeight.w500)),
                    SizedBox(width : 3),
                    Text('마음샘정신건강의학과', style : TextStyle(color : Color(0xff929292), fontSize: 14, fontWeight: FontWeight.w400))
                  ],
                ),
                SizedBox(height : 7),
                Text("${DateFormat("yyyy.MM.dd(목) hh:mmaaa").format(DateTime.now()).toString()}", style : TextStyle(color : Color(0xff6b6b6b), fontSize: 13, fontWeight: FontWeight.w300)),
